					...
					<td>
						<table class="c8" width="700" cellspacing="0" cellpadding="0" align="center">
								...
								<td class="navybor" colspan="2">
									<table class="c4" width="700" cellspacing="0" cellpadding="0" align="center">
										<tr>
											...
											<td>
												<p class="center white c1"><a href="about.html">ABOUT US</a> | <a href="bulldogs.html">CLASSES</a> | <a href="schedule.html">SCHEDULES &amp; FEES</a> | <a href="coaches.html">COACHES</a> | <a href="venuetis.html"><b>VENUES</b></a></p>
											</td>
							...
							<tr>
								<td class="navybor c7" colspan="2">
									<table class="c6" border="0" width="660" cellspacing="0" cellpadding="5" align="center" bordercolor="#FF0000">
										<tr>
											<td colspan="3">
												<p class="men"><img src="../../images/mats/spacer.gif" width="10" height="12" align="bottom" /><b class="red">Registration | <a class="content" href="campreg.php">Camp Registration</a></b></p>
											</td>
										</tr>
										<tr>
											<td><img src="../../images/mats/spacer.gif" width="2" height="10" align="left" /></td>
											<td class="boxborder">
												<h1>British Football Academy Trial Request. <br>
													You can find out more information on joining <a class="content" href="joining.html">here</a></h1>
												<?php
                                            IF (!isset($_GET['form'])) {
                                                ?>
												<p>
												...
												<form action="registration.php?form=true" method="post">
													<table border="0" width="590" cellpadding="0">
														<tr>
															...
															<td>
																<h4>
                                                                    Tokyo Locations - TIS<input type="radio" name="venue" value="TIS" checked="checked" />  Sarugaku<input type="radio" name="venue" value="SARUGAKU" /> Nanzan<input type="radio" name="venue" value="NANZAN" /> Shibaura<input type="radio" name="venue" value="SHIBAURA" /><br />
																</h4>
															</td>
														</tr>
														<tr>
							...
							<tr>
								...
								<td bgcolor="#ff3300" width="350" height="97" background="../../images/links/SummerCamp_ad.png"><a href="jaguars.html"><img src="../../images/links/Jaguars_ad.jpg" width="350" alt="BFA Jaguars" height="100"></a></td>
							</tr>
						</table>
					</td>
				</tr>
